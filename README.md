...
4. Right-click the Essence to identify it (displays *"This Essence holds the appearance of: [Item Name]"* in chat)
5. Right-click the Essence and select a compatible equipped item from the menu to apply the appearance.
...
- Because no client patches are used, all Essences share the same generic item icon in your bags. You can easily identify them via the Gossip Menu or by Right-Clicking them.
...
- **`01_world_transmog_items.sql`** — Creates the four base item templates (23885, 35517, 24315, 38567)
...
- **Author:** Zyggy123 (based on concepts from Rochet2's classic Eluna Transmogrifier)
